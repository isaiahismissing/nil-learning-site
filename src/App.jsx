  ...
  return (
    <> <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/logMenu" element={<div><Log001Card /> <Log002Card /> <Log003Card /> <Log004Card /> <Log005Card /> <Log006Card /> <Log007Card /> <Log008Card /> <Log009Card /> <Log010Card /> <AudioLog001Card /> <AudioLog002Card /> <AudioLog003Card /> <AudioLog004Card /> <TextLog001Card /> <TextLog002Card /> <TextLog003Card /> <TextLog004Card /></div>}/>
        ...
        <Route path="/audio001" element={<div><AudioPlayer media="/audio001.mp3" picture="/audio001image.jpg" logNumber="001" text="this used to be my old room, you can see some posters and the desktop PCs, a bit cluttered but cozy."/><BackButton /> <DecorLines/></div>}/>
        <Route path="/audio002" element={<div><AudioPlayer media="/audio002.mp3" picture="/audio002image.JPG" logNumber="002" text="the view from my old room's window, you could see everyone in the parking lot, and they could stare back at you too."/><BackButton /> <DecorLines/></div>}/>
        <Route path="/audio003" element={<div><AudioPlayer media="/audio003.mp3" picture="/audio003image.jpg" logNumber="003" text=""/><BackButton /> <DecorLines/></div>}/>
        <Route path="/audio004" element={<div><AudioPlayer media="/audio004.mp3" picture="/audio004image.jpg" logNumber="004" text="i got out of the station and saw this beautiful shot."/><BackButton /> <DecorLines/></div>}/>
